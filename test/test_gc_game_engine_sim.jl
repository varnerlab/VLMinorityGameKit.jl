...
path_to_results_dir = "/Users/jeffreyvarner/Desktop/proposals/VLMinorityGameKit.jl/test/data/results/SIM-T-M10-S5-NA1001-L2.bson"
...
for sample_index = 1:number_of_samples
    result = execute(gameWorld; liquidity=2.0 * numberOfTraders, numberOfTimeSteps=numberOfTimeSteps);
...
simulation_dictionary["liquidity"] = 2.0 * numberOfTraders
