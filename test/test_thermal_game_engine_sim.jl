...
path_to_results_dir = "/Users/jeffreyvarner/Desktop/julia_work/VLMinorityGameKit.jl/test/data/results/SIM-T-M10-S5-NA1001-L7.bson"
...
for sample_index = 1:number_of_samples
    result = execute(gameWorld, numberOfTimeSteps; liquidity=7.0 * numberOfTraders);
...
simulation_dictionary["liquidity"] = 7.0 * numberOfTraders
